...
//    }
     ...
     * 监听topic1主题,单条消费
     */
    @KafkaListener(topics = "test", topicPattern = "1", groupId = "group_c")
    public void listen0(ConsumerRecord<String, String> record) {
        consumer(record);
    }
     ...
     * 监听topic5,批量消费
     */
    @KafkaListener(topics = "${topicName.test}", groupId = "group_c", containerFactory = "batchFactory")
